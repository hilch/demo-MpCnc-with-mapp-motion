TYPE
	...
	McCamDataType : STRUCT  (*structure with cam data*)
		...
		PolynomialNumber : UDINT; (*Number of polynomials: 1..64*)
		PolynomialData : ARRAY[0..63] OF McPolynomialDataType; (*Polynomial coefficient*)
	END_STRUCT;
	...
	McAdvCalcCamFromPointsParType : STRUCT
 		...
 		NumberOfPolynomials : USINT; (*Maximum number of calculated polynomials: 1 .. 64*)
 		MasterPeriod 		: DINT; (*Length of the master period*)
